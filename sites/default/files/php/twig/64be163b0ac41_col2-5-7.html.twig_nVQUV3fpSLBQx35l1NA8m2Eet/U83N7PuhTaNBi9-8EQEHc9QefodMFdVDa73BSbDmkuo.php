...
/* themes/custom/stack/layouts/col2-5-7.html.twig */
class __TwigTemplate_34099a19d6582aa48faced9783bebecf extends Template
{
    private $source;
    private $macros = [];
    ...
    <div";
            // line 22
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["region_attributes"] ?? null), "first", [], "any", false, false, true, 22), "addClass", [0 => "col-sm-5"], "method", false, false, true, 22), 22, $this->source), "html", null, true);
            echo ">
      ";
            // line 23
    ...
    <div";
            // line 26
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["region_attributes"] ?? null), "second", [], "any", false, false, true, 26), "addClass", [0 => "col-sm-7"], "method", false, false, true, 26), 26, $this->source), "html", null, true);
            echo ">
      ";
            // line 27
...
";
    ...
    {
        return "themes/custom/stack/layouts/col2-5-7.html.twig";
    }
    ...
    {
        return new Source("", "themes/custom/stack/layouts/col2-5-7.html.twig", "/Users/personal/Documents/workspace/sites/renewal-proj-new/themes/custom/stack/layouts/col2-5-7.html.twig");
    }
